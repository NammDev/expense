...
const baseUrl = 'https://expense.namk.dev'
const appUrl = 'https://app.expense.namk.dev'
const githubUrl = 'https://github.com/NammDev/expense'
const twitterUrl = 'https://x.com/namdeveloper_ca'
        ...
        <Body className='bg-white my-auto mx-auto font-sans'>
          <Container className='border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[465px]'>
            ...
            <Text className='text-black text-[14px] leading-[24px]'>
              Hi, I{"'"}m Gokul, creator of the Expense.fyi, an open-source app to deliver financial
              clarity through spending analysis. We are excited to have you on board.
            </Text>
            <Text className='text-black text-[14px] leading-[24px]'>
