...
const Footer = ({ className }: { className?: String }) => {
  return (
    ...
    >
      <div className='flex justify-center w-full xs:mb-0'>
        <div className='flex flex-row items-center justify-between gap-6 border-t border-white/5'>
          <p className='text-xs text-gray-600'>
            &copy; Copyright {new Date().getFullYear()}, expense.namk.dev
          </p>
          <div className='flex gap-3'>
            <Link className='group' href={url.twitter}>
              ...
              <svg
                viewBox='0 0 20 20'
                aria-hidden='true'
                className='w-5 h-5 transition fill-sky-500 group-hover:fill-sky-400'
              >
            ...
            <Link className='group' href={url.github}>
              ...
              <svg
                viewBox='0 0 20 20'
                aria-hidden='true'
                className='w-5 h-5 transition fill-gray-950 group-hover:fill-gray-600'
              >
                <path
                  fillRule='evenodd'
                  clipRule='evenodd'
