      ...
      <header className='relative m-auto h-[56px] max-w-4xl pt-3'>
        <div className='absolute left-0 right-0 top-3 z-20 flex items-center justify-between'>
          <Link href={'/'} className='flex max-w-[180px] items-center p-3 text-2xl'>
            <Image src={logo} width={30} height={30} alt='expense.namk.dev logo' className='mr-2' />
      ...
      <main>
        ...
        <div className='mx-auto mb-16 mt-16 max-w-md px-3 text-center sm:max-w-lg sm:px-0'>
          ...
          <p className='mt-5 text-base font-normal leading-6 tracking-tight sm:text-lg'>
            Our easy-to-use platform allows you to track and categorize your spending, giving you a
        ...
        <div className='mx-auto mb-16 mt-16 max-w-md px-3 text-center sm:max-w-lg sm:px-0'>
          ...
          <ul className='mt-6 list-decimal px-4 text-left leading-6 [counter-reset:section] sm:px-2'>
            <li className='before::h-2 mt-4 text-base tracking-tight sm:text-lg'>
              <b className='font-sans font-bold text-black'>Easy to use:</b> Track expenses
              on-the-go with categorization and logging.
            </li>
            <li className='before::h-2 mt-4 text-base tracking-tight sm:text-lg'>
              <b className='font-sans font-bold text-black'>Data-driven insights:</b> Expense
              tracker can provide valuable insights into your spending habits, allowing you to make
              more informed decisions.
            </li>
            <li className='before::h-2 mt-4 text-base tracking-tight sm:text-lg'>
              <b className='font-sans font-bold text-black'>Identify overspending:</b> Take control
              of your finances by identifying and reducing overspending with an expense tracker.
            </li>
            <li className='before::h-2 mt-4 text-base tracking-tight sm:text-lg'>
              <b className='font-sans font-bold text-black'>Real-time visibility:</b> Monitor your
              expenses in real-time, whether you are at home or on-the-go, with a user-friendly
              interface
            </li>
          </ul>
        </div>
            ...
            <div className='min-w-[330px] divide-y divide-gray-600 rounded-lg bg-zinc-900 text-left shadow-sm sm:mr-8'>
              <div className='p-5 py-6'>
                ...
                <a
                  ...
                  href='https://app.expense.namk.dev/signup'
                >
                  Start for free
                </a>
              </div>
