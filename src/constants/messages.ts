...
export const emails = {
  ...
  account: {
    deleted: 'Your expense.namk.dev account is Deleted!',
  },
  welcome: {
    subject: '✨ Welcome to expense.namk.dev',
  },
  usageLimit: {
    premiumExpired: {
  ...
  from: 'Gokul from expense.namk.dev <hello@expense.namk.dev>',
  signin: { subject: 'Sign in link for expense.namk.dev' },
  signup: { subject: 'Sign up link for expense.namk.dev' },
}
